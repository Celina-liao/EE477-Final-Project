...
create_clock -name clk -period 6.0 [get_ports clk_i]
set_clock_uncertainty 0.100 [get_clocks clk]

# Always set the input/output delay as half periods for clock setup checks
set_input_delay  3.0 -max -clock [get_clocks clk] [all_inputs]
set_output_delay 3.0 -max -clock [get_clocks clk] [all_outputs]
